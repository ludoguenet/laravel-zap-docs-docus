...
For **first/second/third/fourth/last weekday of the month** (e.g. “every 1st Wednesday”), use [Monthly ordinal weekday](/docs/guides/schedule-patterns/ordinal-weekday). For intervals of **4, 5, 7, 8, 9, 10, or 11 months**, use [Dynamic monthly (every X months)](/docs/guides/schedule-patterns/dynamic-monthly).
