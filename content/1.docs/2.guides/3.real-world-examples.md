...
### Monthly Standup & Month-End (Ordinal Weekday)

For “which weekday of the month” (e.g. 1st Wednesday, last Monday), use [Monthly ordinal weekday](/docs/guides/schedule-patterns/ordinal-weekday):
...
## 💡 Filter schedules by metadata (tip)
