...
One end-to-end example: define availability, block time, create an appointment, then get bookable slots. For recurrence options (daily, weekly, monthly, [ordinal weekday](/docs/guides/schedule-patterns/ordinal-weekday), etc.), see [Schedule patterns](/docs/guides/schedule-patterns). For querying and availability, see [Query & Check](/docs/guides/query-check).
