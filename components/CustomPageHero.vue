<template>
    ...
    <div class="absolute inset-0 -z-10">
      <div class="absolute top-0 left-1/4 w-96 h-96 bg-amber-200/20 rounded-full blur-3xl"/>
      <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-amber-300/20 rounded-full blur-3xl"/>
    </div>
      ...
      <div class="text-center max-w-6xl mx-auto">
        ...
        <div class="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-slate-500">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="font-medium">Laravel 10+ Compatible</span>
          </div>
          <div class="flex items-center gap-2">
            <svg class="w-5 h-5 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
            </svg>
            <span class="font-medium">Production Ready</span>
          </div>
        </div>
      </div>
    </div>
