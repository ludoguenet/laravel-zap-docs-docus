    ...
    <div class="max-w-6xl mx-auto px-6">
      <header class="max-w-3xl">
        ...
        <p class="mt-3 text-sm md:text-base text-gray-600 dark:text-gray-200">
          Laravel Zap keeps the rules for when something <span class="font-semibold">can</span>
          happen and when it <span class="font-semibold">must not</span> happen in one
          place, so your application stays predictable as it grows.
        </p>
      </header>
      ...
      >
        <article
          class="rounded-xl bg-white dark:bg-[#321a57] shadow-lg border border-[#552583]/10 dark:border-[#FDB927]/20 p-6 flex flex-col gap-3"
        >
          <div class="flex items-center gap-3">
            <span
              class="flex h-9 w-9 items-center justify-center rounded-xl bg-[#552583]/10 text-[#552583] dark:bg-[#FDB927]/15 dark:text-[#FDB927]"
            >
            ...
            >
              ...
              <span
                class="h-1 w-6 rounded-full bg-[#FDB927] inline-block"
                aria-hidden="true"
              />
            </h3>
          </div>
          <p class="text-gray-600 dark:text-gray-200 text-sm">
            Express working hours, blocked periods and confirmed bookings with a
            fluent, Eloquent-friendly API.
          </p>
        </article>
        ...
        >
          ...
          <p class="text-gray-600 dark:text-gray-200 text-sm">
            Configure which schedules may overlap and let Zap handle conflict
        ...
        >
          ...
          <p class="text-gray-600 dark:text-gray-200 text-sm">
            Generate bookable slots with fixed or dynamic durations, gaps and
            custom filters for your UI.
          </p>
        </article>
      </div>
